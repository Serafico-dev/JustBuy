...
<head>
	...
	<title>Statistiche - JustBuy</title>
...
<body>
	...
	<% 
		...
		List<Prodotto> listaProdotti = businessLogic.prodottoRetrieveAll();
	...
	<div class="container">
		...
		<div class="row">
			<div class="col mt-5">
				<table class="display" id="tabellaStatistiche">
					<thead>
						<tr>
							<th scope="col">ID</th>
							<th scope="col">Nome</th>
							<th scope="col">Spesa totale</th>
							<th scope="col">Quantità vendute</th>
						</tr>
					</thead>
					<tbody>
						<% 
							for (Prodotto p : listaProdotti) {
								List<Ordine> listaOrdini = p.getOrdini();
								Integer quantitaVendute = listaOrdini.size();
						%>	
						<tr>	
							<td><%=p.getId()%></td>
							<td><%=p.getNome()%></td>
							<td><%=euro.format(quantitaVendute * p.getPrezzo()).replace("$", "\u20ac ")%></td>
							<td><%=quantitaVendute%></td>
						</tr>
						<%
							}
						%>
