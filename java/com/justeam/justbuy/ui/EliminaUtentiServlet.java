...
@WebServlet("/eliminaUtenti")
public class EliminaUtentiServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			businessLogic.utenteDelete(Integer.parseInt(req.getParameter(ChiaviUtente.OPERAZIONI_UTENTI)));
			req.setAttribute(ChiaviUtente.STATUS_OPERAZIONE, "Utente eliminato con successo!");	
