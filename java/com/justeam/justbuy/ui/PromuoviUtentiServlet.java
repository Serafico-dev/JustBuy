...
@WebServlet("/promuoviUtenti")
public class PromuoviUtentiServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			businessLogic.utentePromuovi(Integer.parseInt(req.getParameter(ChiaviUtente.OPERAZIONI_UTENTI)));
			req.setAttribute(ChiaviUtente.STATUS_OPERAZIONE, "Utente promosso con successo!");	
